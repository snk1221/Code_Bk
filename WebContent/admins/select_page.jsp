...
<table id="table-1">
   <tr><td><h3>IBM admins: Home</h3><h4>( MVC )</h4></td></tr>
</table>

<p>This is the Home page for IBM users: Home</p>
...
<ul>
  <li><a href='listAllAdmins.jsp'>List</a> all admins.  <br><br></li>
...
<ul>
  <li><a href='addAdmins.jsp'>Add</a> a new Admins.</li>
</ul>
